		...
		<div class="ad clearfix">
			...
			<div class="navBar f-fr">
				<ul class="navList">
					...
					<li class="navItem"><a href="javascript:void();" class="releaseMes">发布消息</a></li>
				</ul>
			</div>
		</div>
		<div class="wrap">
			...
			<div class="mesMain clearfix">
				...
				<div class="f-fl rightArea">
					<div class="goodsMesTxtBoxWrap">
						<form id="formImg" action="/things/CodeJson/tie" enctype='multipart/form-data' method='post'>
							<p class="goodsMesTxtBox clearfix">
								<span class="goodsMesTxtTitle">物品名称</span>
								<i class="goodsMesTxt">
									<input type="text" class="tieGoods" name="name">
								</i>
							</p>
							<style>
...
.tieGoodsSubmit:hover{
	background: #F892F2;
							...
							<p class="goodsMesTxtBox clearfix">
								...
								<i class="goodsMesTxt"><textarea name="remark" id="" cols="30" rows="10" class="tieGoods"></textarea></i>
							</p>
							<div class="goodsImg goodsMesTxtBox clearfix">
								...
								<div class="f-fl">
									...
									<input type="file" value="上传图片"class="" name="pic" />
								</div>
							</div>
							<p class="goodsMesTxtBox clearfix">
								<span class="goodsMesTxtTitle">&nbsp;</span>
								<i class="goodsMesTxt">
									<input type="submit" id="" value="确定" class="tieGoodsSubmit" />
								</i>
							</p>
						</form>
					</div>
...
<a href="javascript:;" id="backTop" style="display:none">回到<br>顶部</a>
	...
	<script src="/things/LostAndFound/js/code.js"></script>
</body>
</html>